...
def inject_premium_css():
    ...
    * { font-family: 'Inter', -apple-system, sans-serif; }
    ...
    .signal-calls { background: #ecfdf5; border-color: #10b981; }
    .signal-puts { background: #fef2f2; border-color: #ef4444; }
    .signal-wait { background: #fffbeb; border-color: #f59e0b; }
    .signal-none { background: #f3f4f6; border-color: #d1d5db; }
    .signal-icon { font-size: 36px; margin-bottom: 4px; }
    .signal-title { font-size: 22px; font-weight: 700; }
    .signal-sub { font-size: 11px; color: #6b7280; margin-top: 4px; }
    ...
    .setup-title { font-size: 12px; font-weight: 600; color: #111827; }
    .setup-badge {
        font-size: 9px;
        font-weight: 600;
        padding: 2px 6px;
    ...
    .setup-item-label { color: #6b7280; font-size: 9px; }
    .setup-item-value { 
        font-weight: 600; 
        font-family: 'JetBrains Mono', monospace;
        color: #111827;
    ...
    .check-wait { background: #f9fafb; }
    .check-icon { margin-right: 8px; font-size: 12px; }
    .check-text { flex: 1; color: #374151; }
    .check-detail { font-size: 10px; color: #6b7280; }
    ...
    .profit-label { font-size: 9px; color: #047857; }
    .profit-value { font-size: 13px; font-weight: 700; color: #047857; font-family: 'JetBrains Mono', monospace; }
    
    /* Zone Ladder in Sidebar */
    .zone-ladder {
        font-family: 'JetBrains Mono', monospace;
        font-size: 10px;
        line-height: 1.4;
    }
    .zone-row { padding: 1px 0; color: #6b7280; }
    .zone-highlight {
        background: #dbeafe;
        padding: 2px 6px;
        border-radius: 3px;
